...
<?php 		               		
		               ...
		               ?>
			            ...
			            <div class="description"><br>*Prefix the field name with "taxonomy_" if you want the value to be added as a custom taxonomy ex "taxomony_product_tag" adds the value to the taxonomy named product_tag
