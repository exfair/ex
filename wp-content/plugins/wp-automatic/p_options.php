								...
								<div class="inside main" style="padding-bottom: 14px">
									...
									<div class="TTWForm">
										...
										<div id="field285-container" class="field f_100  ">
											<label for="field285"> Amazon Associate ID* (Used for recieving commisions) <a  target="blank" href="https://affiliate-program.amazon.com/gp/advertising/api/detail/main.html">( Apply here )</a> </label> <input value="<?php   echo get_option( 'wp_amazonpin_aaid' ) ?>" name="wp_amazonpin_aaid" id="field285" type="text">
										</div>
										 
										<div id="field285-container" class="field f_100  ">
											<label for="field285"> Amazon Access Key ID (Optional) <a target="_blank" href="https://www.youtube.com/watch?v=UtQVQPpjDcM"> ( Check the tutorial ) </a>
											</label> <input value="<?php   echo get_option( 'wp_amazonpin_abk' ) ?>" name="wp_amazonpin_abk" id="field285" type="text">
										</div>
										<div id="field285-container" class="field f_100  ">
											<label for="field285"> Amazon Secret Access Key (Optional) </label> <input value="<?php   echo get_option( 'wp_amazonpin_apvtk' ) ?>" name="wp_amazonpin_apvtk" id="field285" type="text">
										</div>
