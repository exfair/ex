<?php
	...
	/*  Copyright 2012-2020  Wordpress Pinterest Automatic  (email : sweetheatmn@gmail.com) */
	...
	function wp_pinterest_automatic_admin_scripts2(){
		...
		//jquery main
		wp_enqueue_script(
					'wp_pinterest_automatic_jquery_main',plugins_url( '/js/main.js' , __FILE__ ) , array() ,'1.0.9'
		);
	...
	function wp_pinterest_automatic_admin_scripts_new(){ 
		...
		//jquery main
		wp_enqueue_script(
				'wp_pinterest_automatic_jquery_main-new',plugins_url( '/js/main.js' , __FILE__ ) , array() ,'1.0.9'
		);
