...
$shopColumns['desktop'] = 'repeat(' . $shopColumns['desktop'] . ', 1fr)';
...
blocksy_output_box_shadow([
	...
	'value' => get_theme_mod('productContentBoxedShadow', blocksy_box_shadow_value([
		'enable' => false,
		'h_offset' => 0,
		'v_offset' => 12,
		'blur' => 18,
...
blocksy_output_responsive([
	...
	'value' => get_theme_mod('productContentBoxedSpacing', [
		'desktop' => '40px',
		'tablet' => '35px',
		'mobile' => '20px',
	]),
