	...
	<div class="row">
		<div class="col-lg-<?php echo esc_attr( $news_box_grid_number ); ?>">
			...
			the_posts_pagination( array(
				'prev_text'          => esc_html__( 'Previous', 'news-box-free' ),
				'next_text'          => esc_html__( 'Next', 'news-box-free' ),
				'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'news-box-free' ) . ' </span>',
			) );
				else :
